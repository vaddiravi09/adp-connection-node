...
function ADPConnection(connConfig) {
	...
	*/
	...
	this.externalConfig = function externalConfig(cfg) {
		var externalcfg = cfg || {};
		Object.keys(externalcfg).forEach(function keysForEachCb(key) {
			if(typeof this.connType[key] !== 'undefined') {
				this.connType[key] = externalcfg[key];
			}
		}.bind(this));
	};
